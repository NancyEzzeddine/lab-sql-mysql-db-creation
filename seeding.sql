...
(6, '7YHNT1X23FU6OQ9PL', 'Volvo', 'V60 Cross Country', 2019, 'Gray');


INSERT INTO Customers (Customer_ID, Name, Phone, Address, City, State, Country, ZipCode)
VALUES 
...
INSERT INTO Salespersons (Salesperson_ID, Name, StoreLocation)
VALUES 
...
INSERT INTO Invoices (Invoice_ID, InvoiceNumber, InvoiceDate, Car_ID, Customer_ID, Salesperson_ID)
VALUES 
